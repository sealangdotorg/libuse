...
libfind_pkg_check_modules( GTEST_PKGCONF libgtest )
...
if( EXISTS "${LIBGTEST_INCLUDE_DIR}" AND
    EXISTS "${LIBGTEST_LIBRARY}" AND
    EXISTS "${LIBGTEST_MAIN}" AND
    ${LIBGTEST_INCLUDE_DIR} AND
    ${LIBGTEST_LIBRARY} AND
    ${LIBGTEST_MAIN}
    )
