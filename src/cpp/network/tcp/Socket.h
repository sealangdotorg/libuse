...
#ifndef _LIBSTDHL_CPP_NETWORK_TCP_SOCKET_H_
#define _LIBSTDHL_CPP_NETWORK_TCP_SOCKET_H_

#include <libstdhl/network/Socket>
#include <libstdhl/network/tcp/Packet>
#include <libstdhl/network/tcp/Protocol>
...
#endif // _LIBSTDHL_CPP_NETWORK_TCP_SOCKET_H_
