...
#pragma once
#ifndef _LIBSTDHL_CPP_NETWORK_DAP_INTERFACE_H_
#define _LIBSTDHL_CPP_NETWORK_DAP_INTERFACE_H_

#include <libstdhl/net/dap/Message>
...
/**
   ...
   https://microsoft.github.io/debug-adapter-protocol/specification @ 1.32.x
*/
        ...
        namespace DAP
        {
            class ServerInterface
            {
              public:
                ...
                void notify( const EventMessage& message );

                void flush( const std::function< void( const Message& ) >& callback );

                // TODO: FIXME: @ppaulweber: add DAP API
...
#endif  // _LIBSTDHL_CPP_NETWORK_DAP_INTERFACE_H_
